...
## 🚀 Steps Performed
1. Created a simple network topology using 2 PCs, 1 switch, and 1 router.  
2. Assigned static IP addresses to each PC.  
3. Configured router interface with an IP address and enabled it.  
4. Connected devices using straight-through Ethernet cables.  
5. Tested successful communication between devices using `ping`.  
...
- Configured router and switch for seamless connectivity.  
